...
**No distractions. No accounts. No cloud.**
Just you and what needs to get done.
...
Planning needs to be visible, direct, and frictionless — like a board on your wall. 

At the same time, it solves a common problem in today's tools:
- Bloated features
- Internet dependency
...
- **PBKDF2 (100,000 iterations)** → Secure key derivation from your password.
- **Zero-Knowledge Architecture** → Only you can access your content. No one else.
